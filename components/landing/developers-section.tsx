...
const codeExamples = [
  {
    label: "Install",
    code: `npm install @datatrack/sdk

# or
yarn add @datatrack/sdk
pnpm add @datatrack/sdk`,
  },
  {
    label: "Initialize",
    code: `import { Datatrack } from '@datatrack/sdk'

const datatrack = new Datatrack({
  apiKey: process.env.DATATRACK_KEY
})`,
  },
  {
    label: "Deploy",
    code: `const app = await datatrack.deploy({
  name: 'my-app',
  region: 'auto',
  scaling: {
    min: 1,
